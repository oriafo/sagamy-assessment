...
import { Logout } from 'src/app/Login/domain/login.data';
...
//sessionGuid = {} as Logout;

    constructor(public appMain: AppMainComponent, public app: AppComponent, private router:Router, private loginService:LoginService) {
    }
    ...
    logout(): void{
                ...
                // this.sessionGuid = JSON.parse("sessionStorage.getItem('SessionId')")
                console.log(typeof(this.loginService.sessionVariable))
                this.loginService.cleintLogout(this.loginService.sessionVariable).subscribe(data=>{
